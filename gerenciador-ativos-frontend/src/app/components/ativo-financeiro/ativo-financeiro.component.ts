...
export class AtivoFinanceiroComponent {
  ...
  incluirAtivoFinanceiro(): void {
    this.ativoFinanceiroService
      .incluirAtivoFinanceiro(this.ativoFinanceiro)
      .subscribe({
        next: (response) => {
          this.ativoFinanceiro = response;
        },
  ...
  editarAtivoFinanceiro(): void {
    this.ativoFinanceiroService
      .editarAtivoFinanceiro(this.ativoFinanceiro)
      .subscribe({
        next: (response) => {
          this.ativoFinanceiro = response;
  ...
  consultarAtivoFinanceiro(): boolean {
    this.ativoFinanceiroService
      .consultarAtivoFinanceiro(this.ativoFinanceiro)
      .subscribe({
        next: (response) => {
          this.ativoFinanceiro = response;
          return true;
  ...
  consultarAtivosFinanceiros(): void {
    this.ativoFinanceiroService.consultarAtivosFinanceiros().subscribe({
      next: (response) => {
        this.listaAtivosFinanceiros = response;
      },
      error: (response) => console.error(response),
      complete: () => console.log(this.listaAtivosFinanceiros),
    });
  ...
  removerAtivoFinanceiro(): void {
    this.ativoFinanceiroService
      .removerAtivoFinanceiro(this.ativoFinanceiro)
      .subscribe({
        next: (_) => {

...
export class AtivoFinanceiroService {
  ...
  incluirValorMercado(ativoFinanceiro: AtivoFinanceiro, valorMercado: ValorMercado): Observable<any> {
    return this.httpClient
      .post<ValorMercado>("http://localhost:8080/api/v0/ativos-financeiros/" + ativoFinanceiro.id + "/valores-mercado", valorMercado);
  }

  consultarValoresMercado(ativoFinanceiro: AtivoFinanceiro): Observable<any> {
    return this.httpClient
      .get<ValorMercado[]>("http://localhost:8080/api/v0/ativos-financeiros/" + ativoFinanceiro.id + "/valores-mercado");
  }

  removerValorMercado(ativoFinanceiro: number, valorMercado: ValorMercado): Observable<any> {
    return this.httpClient
      .delete("http://localhost:8080/api/v0/ativos-financeiros/" + ativoFinanceiro + "/valores-mercado/" + valorMercado.id)
  }
